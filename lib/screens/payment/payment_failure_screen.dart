        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Une erreur est survenue lors du traitement de votre transaction. Veuillez vérifier votre solde ou essayer un autre moyen de paiement.',
              ...
              TextButton(
                ...
                child: const Text('ANNULER ET RETOURNER À L\'ACCUEIL', style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold)),
              ),
            ],
          ),
        ),
